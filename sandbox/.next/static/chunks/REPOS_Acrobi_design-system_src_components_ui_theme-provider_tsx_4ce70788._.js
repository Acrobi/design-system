...
"[project]/REPOS/Acrobi/design-system/src/components/ui/theme-provider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ThemeProvider(param) {
    let { children, defaultMode = "system", defaultTheme = "base", modeStorageKey = "acrobi-theme-mode", themeStorageKey = "acrobi-color-theme", enableSystem = true } = param;
    _s();
    ...
    const applyThemeMode = __TURBOPACK__imported__module__$5b$project$5d2f$REPOS$2f$Acrobi$2f$design$2d$system$2f$Acrobi$2d$Design$2d$System$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$2_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ThemeProvider.useCallback[applyThemeMode]": (newMode)=>{
            ...
            console.log("🎨 Theme Mode: ".concat(newMode, " (resolved: ").concat(resolved, ")"));
        }
    }["ThemeProvider.useCallback[applyThemeMode]"], []);
    // ===================================
    ...
    const applyColorTheme = __TURBOPACK__imported__module__$5b$project$5d2f$REPOS$2f$Acrobi$2f$design$2d$system$2f$Acrobi$2d$Design$2d$System$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$2_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ThemeProvider.useCallback[applyColorTheme]": async (newTheme)=>{
            ...
            existingThemeLinks.forEach({
                "ThemeProvider.useCallback[applyColorTheme]": (link)=>link.remove()
            }["ThemeProvider.useCallback[applyColorTheme]"]);
            // Don't load CSS for base theme (uses globals.css defaults)
            if (newTheme === 'base') {
                console.log("🎨 Color Theme: ".concat(newTheme, " (using base theme)"));
                return;
            }
            ...
            themeLink.href = "/themes/".concat(newTheme, ".css");
            ...
            // Debug logging - 🚨 DO NOT remove, helpful for development
            console.log("🎨 Color Theme: ".concat(newTheme, " (loaded /themes/").concat(newTheme, ".css)"));
        }
    }["ThemeProvider.useCallback[applyColorTheme]"], []);
    // ===================================
    ...
    // ===================================
    const setMode = __TURBOPACK__imported__module__$5b$project$5d2f$REPOS$2f$Acrobi$2f$design$2d$system$2f$Acrobi$2d$Design$2d$System$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$2_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ThemeProvider.useCallback[setMode]": (newMode)=>{
    ...
    const toggleMode = __TURBOPACK__imported__module__$5b$project$5d2f$REPOS$2f$Acrobi$2f$design$2d$system$2f$Acrobi$2d$Design$2d$System$2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$2_$40$babel$2b$core$40$7$2e$28$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "ThemeProvider.useCallback[toggleMode]": ()=>{
...
_s(ThemeProvider, "Rh04dj9OfG81Y4nBLJOM0Go4/YE=");
_c = ThemeProvider;
function useTheme() {
    _s1();
...
//# sourceMappingURL=REPOS_Acrobi_design-system_src_components_ui_theme-provider_tsx_4ce70788._.js.map