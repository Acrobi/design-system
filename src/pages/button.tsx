    ...
    <SensoryProvider>
      <div className="min-h-screen bg-background text-foreground p-8">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold">Advanced Button Component Test Suite</h1>
            <p className="text-muted-foreground text-lg">
              Testing the architectural Button component with constitutional compliance
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="flex flex-wrap gap-4">
                <Button variant="primary" onClick={() => playSound(440, 0.1)}>Default</Button>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <Button size="md" onClick={() => playSound(550, 0.1)}>Default</Button>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Button size="sm" variant="outline" onClick={() => playSound(550, 0.1)}>
                    <Icon metaphor="download" />
                  </Button>
                  <Button size="sm" variant="destructive" onClick={() => playSound(330, 0.1)}>
                    <Icon metaphor="delete" />
                  </Button>
                  <Button size="sm" variant="secondary" onClick={() => playSound(660, 0.1)}>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Button size="md" onClick={() => playSound(550, 0.1)}>
                    <Icon metaphor="add" className="mr-2 h-4 w-4" />
                    Default
                  </Button>
