      ...
      <section className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-5 md:grid-cols-10 gap-2">
            {[50, 100, 200, 300, 400, 500, 600, 700, 800, 950].map((shade) => (
              <div key={shade} className="text-center">
                <div
                  className={`bg-purple-${shade} h-12 w-12 rounded-lg mx-auto mb-1 border`}
                />
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-5 md:grid-cols-10 gap-2">
            {[50, 100, 200, 300, 400, 500, 600, 700, 800, 950].map((shade) => (
              <div key={shade} className="text-center">
                <div
                  className={`bg-gray-${shade} h-12 w-12 rounded-lg mx-auto mb-1 border`}
                />
                <p className="text-xs text-muted-foreground">{shade}</p>
              </div>
            ))}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-5 md:grid-cols-10 gap-2">
            {[50, 100, 200, 300, 400, 500, 600, 700, 800, 950].map((shade) => (
              <div key={shade} className="text-center">
                <div
                  className={`bg-blue-${shade} h-12 w-12 rounded-lg mx-auto mb-1 border`}
                />
                <p className="text-xs text-muted-foreground">{shade}</p>
              </div>
            ))}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-5 md:grid-cols-10 gap-2">
            {[50, 100, 200, 300, 400, 500, 600, 700, 800, 950].map((shade) => (
              <div key={shade} className="text-center">
                <div
                  className={`bg-green-${shade} h-12 w-12 rounded-lg mx-auto mb-1 border`}
                />
                <p className="text-xs text-muted-foreground">{shade}</p>
              </div>
            ))}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-5 md:grid-cols-10 gap-2">
            {[50, 100, 200, 300, 400, 500, 600, 700, 800, 950].map((shade) => (
              <div key={shade} className="text-center">
                <div
                  className={`bg-red-${shade} h-12 w-12 rounded-lg mx-auto mb-1 border`}
                />
                <p className="text-xs text-muted-foreground">{shade}</p>
              </div>
            ))}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-5 md:grid-cols-10 gap-2">
            {[50, 100, 200, 300, 400, 500, 600, 700, 800, 950].map((shade) => (
              <div key={shade} className="text-center">
                <div
                  className={`bg-orange-${shade} h-12 w-12 rounded-lg mx-auto mb-1 border`}
                />
                <p className="text-xs text-muted-foreground">{shade}</p>
              </div>
            ))}
