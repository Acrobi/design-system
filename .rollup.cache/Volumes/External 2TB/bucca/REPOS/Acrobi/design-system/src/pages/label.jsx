      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input id="basic-input" type="text" className="mt-1 w-full p-2 border rounded-md" placeholder="Type something..."/>
          </div>
          <div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input id="email-input" type="email" className="mt-1 w-full p-2 border rounded-md" placeholder="user@example.com"/>
          </div>
          <div>
            <Label htmlFor="password-input" icon="eye-closed">
              Password
            </Label>
            <input id="password-input" type="password" className="mt-1 w-full p-2 border rounded-md" placeholder="Enter password"/>
          </div>
          <div>
            <Label htmlFor="search-input" icon="search">
              Search
            </Label>
            <input id="search-input" type="search" className="mt-1 w-full p-2 border rounded-md" placeholder="Search items..."/>
          </div>
          <div>
            <Label htmlFor="file-input" icon="upload">
              Upload File
            </Label>
            <input id="file-input" type="file" className="mt-1 w-full p-2 border rounded-md"/>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input id="styled-input" type="text" className="mt-1 w-full p-2 border rounded-md" placeholder="Styled label example"/>
          </div>
          <div>
            <Label htmlFor="large-input" className="text-lg font-semibold">
              Large Label
            </Label>
            <input id="large-input" type="text" className="mt-1 w-full p-2 border rounded-md" placeholder="Large label example"/>
          </div>
          <div>
            <Label htmlFor="custom-input" className="text-blue-600 uppercase tracking-wide">
              Custom Styled Label
            </Label>
            <input id="custom-input" type="text" className="mt-1 w-full p-2 border rounded-md" placeholder="Custom styled label"/>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4 p-6 border rounded-lg">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input id="name" type="text" className="mt-1 w-full p-2 border rounded-md" placeholder="John Doe"/>
            </div>
            <div>
              <Label htmlFor="email" icon="mail">
                Email Address
              </Label>
              <input id="email" type="email" className="mt-1 w-full p-2 border rounded-md" placeholder="john@example.com"/>
            </div>
            <div>
              <Label htmlFor="message" icon="edit">
                Message
              </Label>
              <textarea id="message" className="mt-1 w-full p-2 border rounded-md" rows={4} placeholder="Your message here..."/>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4 p-6 border rounded-lg">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <input id="horizontal-name" type="text" className="flex-1 p-2 border rounded-md" placeholder="John Doe"/>
            </div>
            <div className="flex items-center gap-4">
              <Label htmlFor="horizontal-email" icon="mail" className="min-w-[120px]">
                Email
              </Label>
              <input id="horizontal-email" type="email" className="flex-1 p-2 border rounded-md" placeholder="john@example.com"/>
            </div>
            <div className="flex items-center gap-4">
              <Label htmlFor="horizontal-phone" icon="phone" className="min-w-[120px]">
                Phone
              </Label>
              <input id="horizontal-phone" type="tel" className="flex-1 p-2 border rounded-md" placeholder="+1 (555) 123-4567"/>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input id="accessible-input" type="text" className="mt-1 w-full p-2 border rounded-md" aria-describedby="input-help" placeholder="This input has proper accessibility"/>
          ...
          <div>
            ...
            <input id="required-input" type="text" className="mt-1 w-full p-2 border rounded-md" required aria-required="true" placeholder="This field is required"/>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input id="interactive-input" type="text" className="mt-1 w-full p-2 border rounded-md" onChange={(e) => {
          ...
          <div>
            ...
            <div className="flex gap-2 mt-1">
              <input id="toggle-input" type="password" className="flex-1 p-2 border rounded-md" defaultValue="secret-password"/>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input id="success-input" type="text" className="mt-1 w-full p-2 border rounded-md border-green-300" defaultValue="Valid data"/>
          </div>
          <div>
            <Label htmlFor="error-input" icon="error" className="text-red-600">
              Error Input
            </Label>
            <input id="error-input" type="text" className="mt-1 w-full p-2 border rounded-md border-red-300" defaultValue="Invalid data"/>
          </div>
          <div>
            <Label htmlFor="warning-input" icon="warning" className="text-yellow-600">
              Warning Input
            </Label>
            <input id="warning-input" type="text" className="mt-1 w-full p-2 border rounded-md border-yellow-300" defaultValue="Needs attention"/>
          </div>
          <div>
            <Label htmlFor="info-input" icon="info" className="text-blue-600">
              Info Input
            </Label>
            <input id="info-input" type="text" className="mt-1 w-full p-2 border rounded-md border-blue-300" defaultValue="Additional info"/>
          </div>
        </div>
      </div>
    </div>);
