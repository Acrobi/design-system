...
export function ThemeSelectorCompact() {
    ...
    return (<div className="flex items-center gap-2">
      ...
      <Button variant="ghost" size="sm" onClick={toggleMode} className="px-2 py-1 h-8" title={`Current: ${mode} (${resolvedMode}) - Click to toggle`}>
...
//# sourceMappingURL=theme-selector-compact.jsx.map