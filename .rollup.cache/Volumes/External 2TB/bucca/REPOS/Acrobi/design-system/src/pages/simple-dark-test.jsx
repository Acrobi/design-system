...
export default function SimpleDarkTest() {
    ...
    return (<div className="min-h-screen p-8" style={{ backgroundColor: 'var(--color-background)', color: 'var(--color-foreground)' }}>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="p-6 border-2 rounded-lg" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-card)', color: 'var(--color-card-foreground)' }}>
          ...
          <button onClick={toggleMode} className="mt-4 px-6 py-3 rounded-lg font-semibold" style={{
...
//# sourceMappingURL=simple-dark-test.jsx.map