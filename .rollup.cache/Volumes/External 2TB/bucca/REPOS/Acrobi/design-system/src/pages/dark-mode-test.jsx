...
export default function DarkModeTest() {
    ...
    return (<div className="min-h-screen p-8 bg-background text-foreground">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="p-6 border-2 rounded-lg bg-card text-card-foreground border-border">
          ...
          <button onClick={toggleMode} className="mt-4 px-6 py-3 bg-primary text-primary-foreground rounded-lg font-semibold">
            Toggle Dark Mode
          </button>
        </div>
...
//# sourceMappingURL=dark-mode-test.jsx.map