          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="flex flex-wrap gap-4">
                ...
                <Button variant={isLoading ? "secondary" : "default"} onClick={() => {
            playSound(550, 0.1);
            handleLoadingClick();
        }} disabled={isLoading}>
                  {isLoading ? (<>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <Button className="transition-all duration-300 hover:scale-105 hover:shadow-lg" onClick={() => playSound(440, 0.1)}>
                    Scale Up
                  </Button>
                  <Button variant="outline" className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg" onClick={() => playSound(550, 0.1)}>
                    Lift Up
                  </Button>
                  <Button variant="secondary" className="transition-all duration-300 hover:rotate-3 hover:scale-110" onClick={() => playSound(660, 0.1)}>
                    Wiggle
                  </Button>
                  <Button variant="ghost" className="transition-all duration-300 hover:bg-gradient-to-r hover:from-primary hover:to-primary-foreground hover:text-background" onClick={() => playSound(770, 0.1)}>
                    Gradient
                  </Button>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <Button className="transition-all duration-200 active:scale-95 active:shadow-inner" onClick={() => playSound(440, 0.1)}>
                    Click Press
                  </Button>
                  <Button variant="outline" className="transition-all duration-200 active:rotate-12 active:scale-90" onClick={() => playSound(550, 0.1)}>
                    Spin Click
                  </Button>
                  <Button variant="secondary" className="transition-all duration-300 active:bg-destructive active:text-destructive-foreground" onClick={() => playSound(660, 0.1)}>
                    Color Change
                  </Button>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <Button className="relative overflow-hidden" onClick={() => playSound(440, 0.1)}>
                  ...
                  <Button variant="outline" className="animate-pulse hover:animate-none" onClick={() => playSound(550, 0.1)}>
                    Pulse
                  </Button>
                  <Button variant="secondary" className="animate-bounce hover:animate-none" onClick={() => playSound(660, 0.1)}>
                    Bounce
                  </Button>
                </div>
              </div>
