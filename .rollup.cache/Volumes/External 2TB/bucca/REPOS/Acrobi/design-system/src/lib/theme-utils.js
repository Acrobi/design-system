...
function generatePalette(baseColor, ramp, tinted) {
...
export function generateThemeFromColors({ primary, secondary, tinted }) {
 ...
 */
export function getComputedColor(variableName) {
    if (typeof window === 'undefined')
        return '';
...
export class ColorUtils {
     ...
     */
    static hasContrast(color1, color2, ratio = 4.5) {
 ...
 */
export function useThemeHook(theme, setTheme) {
    const toggleTheme = () => {
