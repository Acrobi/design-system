...
export const ThemeTest = ({ className = '' }) => {
    ...
    return (<div className={`min-h-screen p-8 ${className}`} style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }}>
      <div className="max-w-4xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold mb-6">Theme System Test</h1>

        <div className="flex gap-4 mb-6">
          <button onClick={toggleTheme} className="px-4 py-2 rounded transition-colors" style={{
          ...
          <button onClick={testVariables} className="px-4 py-2 rounded transition-colors" style={{
          ...
          <button onClick={() => setTestResults([])} className="px-4 py-2 rounded transition-colors" style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="p-6 rounded-lg border" style={{
            ...
            <div className="space-y-3">
              <button className="w-full px-3 py-2 rounded text-sm font-medium transition-colors" style={{
            backgroundColor: 'var(--primary)',
            color: 'var(--primary-foreground)'
        }}>
                Primary Button
        ...
        <div className="p-6 rounded-lg border" style={{
          ...
          <div className="space-y-1 max-h-64 overflow-y-auto">
            {testResults.length === 0 ? (<p className="text-muted-foreground">No tests run yet. Click the buttons above to test the theme system.</p>) : (testResults.map((result, index) => (<div key={index} className="text-sm font-mono" style={{ color: 'var(--muted-foreground)' }}>
                  {result}
                </div>)))}
          </div>
        </div>
...
//# sourceMappingURL=ThemeTest.jsx.map