...
function getContrastColorInternal(hexColor: string): string {
...
export function generateThemeFromColors({ primary, secondary, tinted }: { primary: string, secondary?: string, tinted: boolean }): GeneratedTheme {
  ...
  const lightRecipe: ThemeRecipe = {
    ...
    '--primary': pPalette[5],
    '--primary-foreground': getContrastColorInternal(pPalette[5]),
    '--secondary': sPalette[5],
    '--secondary-foreground': getContrastColorInternal(sPalette[5]),
    '--muted': nPalette[2],
    '--muted-foreground': nPalette[6],
    '--accent': nPalette[2],
    '--accent-foreground': getContrastColorInternal(nPalette[2]),
  ...
  const darkRecipe: ThemeRecipe = {
    ...
    '--primary-foreground': getContrastColorInternal(pPaletteDark[5]),
    '--secondary': sPaletteDark[5],
    '--secondary-foreground': getContrastColorInternal(sPaletteDark[5]),
    '--muted': nPaletteDark[2],
    '--muted-foreground': nPaletteDark[6],
    '--accent': nPaletteDark[2],
    '--accent-foreground': getContrastColorInternal(nPaletteDark[2]),
